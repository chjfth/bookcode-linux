...
/* catch_rtsigs.c
    ...
    Usage: catch_rtsigs [block-time [handler-sleep-time]]
		...
		block-time
				specifies an amount of time the program should
				pause after blocking all signals. This allows
				multiple signals to be sent to the process and
				accumulate before the process unblocks all the signals.

		handler-sleep-time
				specifies the amount of time the signal
